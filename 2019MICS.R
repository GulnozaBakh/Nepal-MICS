...
# Print the summary of the model
summary(weighted_logit10D_2019)
...
# Print the summary of the model
summary(weighted_logit11D_2019)
...
# Print the summary of the model
summary(weighted_logit12D_2019)
...
table9D <- weighted_logit9D_2019 %>%
  ...
  bold_labels() %>%
  italicize_levels()
table10D <- weighted_logit10D_2019 %>%
  tbl_regression(label = list(HHAGEx = "Age of Household Head"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
  ...
  bold_labels() %>%
  italicize_levels()
table11D <- weighted_logit11D_2019 %>%
  tbl_regression(label = list(MSTATUS = "Marital Status of Women"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table12D <- weighted_logit12D_2019 %>%
  tbl_regression(label = list(HH51_grouped = "Number of Children under age 5"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table13D <- weighted_logit13D_2019 %>%
  tbl_regression(label = list(HH52_grouped = "Number of Children age 5-17"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
# Stack the tables vertically
stacked_table1AD <- tbl_stack(
  tbls = list(table1D, table2D, table3D, table4D, table5D, table6D, table7D, table8D, table9D, table10D, table11D, table12D, table13D)
)
# Convert the gtsummary table to a gt table
stacked_gtAD <- as_gt(stacked_table1AD) %>%
  gt::tab_header("SEating in a separate place")
# Save the gt table as an image
gtsave(stacked_gtAD, "bivariate_eating_separate.png")
...
# Print the summary of the model
summary(weighted_logit10E_2019)
...
# Print the summary of the model
summary(weighted_logit11E_2019)
...
# Print the summary of the model
summary(weighted_logit12E_2019)
...
table9E <- weighted_logit9E_2019 %>%
  ...
  bold_labels() %>%
  italicize_levels()
table10E <- weighted_logit10E_2019 %>%
  tbl_regression(label = list(HHAGEx = "Age of Household Head"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
  ...
  bold_labels() %>%
  italicize_levels()
table11E <- weighted_logit11E_2019 %>%
  tbl_regression(label = list(MSTATUS = "Marital Status of Women"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table12E <- weighted_logit12E_2019 %>%
  tbl_regression(label = list(HH51_grouped = "Number of Children under age 5"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table13E <- weighted_logit13E_2019 %>%
  tbl_regression(label = list(HH52_grouped = "Number of Children age 5-17"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
# Stack the tables vertically
stacked_table1AE <- tbl_stack(
  tbls = list(table1E, table2E, table3E, table4E, table5E, table6E, table7E, table8E, table9E, table10E, table11E, table12E, table13E)
)
# Convert the gtsummary table to a gt table
stacked_gtAE <- as_gt(stacked_table1AE) %>%
  gt::tab_header("Bathing in a separate place")
# Save the gt table as an image
gtsave(stacked_gtAE, "bivariate_bathing_separate.png")
...
# Print the summary of the model
summary(weighted_logit10F_2019)
...
# Print the summary of the model
summary(weighted_logit11F_2019)
...
# Print the summary of the model
summary(weighted_logit12F_2019)
...
table9F <- weighted_logit9F_2019 %>%
  ...
  bold_labels() %>%
  italicize_levels()
table10F <- weighted_logit10F_2019 %>%
  tbl_regression(label = list(HHAGEx = "Age of Household Head"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
  ...
  bold_labels() %>%
  italicize_levels()
table11F <- weighted_logit11F_2019 %>%
  tbl_regression(label = list(MSTATUS = "Marital Status of Women"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table12F <- weighted_logit12F_2019 %>%
  tbl_regression(label = list(HH51_grouped = "Number of Children under age 5"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table13F <- weighted_logit13F_2019 %>%
  tbl_regression(label = list(HH52_grouped = "Number of Children age 5-17"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
# Stack the tables vertically
stacked_table1AF <- tbl_stack(
  tbls = list(table1F, table2F, table3F, table4F, table5F, table6F, table7F, table8F, table9F, table10F, table11F, table12F, table13F)
)
# Convert the gtsummary table to a gt table
stacked_gtAF <- as_gt(stacked_table1AF) %>%
  gt::tab_header("Staying away from school or work")
# Save the gt table as an image
gtsave(stacked_gtAF, "bivariate_staying_away_from_school_work.png")
...
# Print the summary of the model
summary(weighted_logit10G_2019)
...
# Print the summary of the model
summary(weighted_logit11G_2019)
...
# Print the summary of the model
summary(weighted_logit12G_2019)
...
table9G <- weighted_logit9G_2019 %>%
  ...
  bold_labels() %>%
  italicize_levels()
table10G <- weighted_logit10G_2019 %>%
  tbl_regression(label = list(HHAGEx = "Age of Household Head"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
  ...
  bold_labels() %>%
  italicize_levels()
table11G <- weighted_logit11G_2019 %>%
  tbl_regression(label = list(MSTATUS = "Marital Status of Women"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table12G <- weighted_logit12G_2019 %>%
  tbl_regression(label = list(HH51_grouped = "Number of Children under age 5"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table13G <- weighted_logit13G_2019 %>%
  tbl_regression(label = list(HH52_grouped = "Number of Children age 5-17"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
# Stack the tables vertically
stacked_table1AG <- tbl_stack(
  tbls = list(table1G, table2G, table3G, table4G, table5G, table6G, table7G, table8G, table9G, table10G, table11G, table12G, table13G)
)
# Convert the gtsummary table to a gt table
stacked_gtAG <- as_gt(stacked_table1AG) %>%
  gt::tab_header("Staying away from social gatherings")
# Save the gt table as an image
gtsave(stacked_gtAG, "bivariate_staying_away_from_social_gatherings.png")
...
# Print the summary of the model
summary(weighted_logit10H_2019)
...
# Print the summary of the model
summary(weighted_logit11H_2019)
...
# Print the summary of the model
summary(weighted_logit12H_2019)
...
table9H <- weighted_logit9H_2019 %>%
  ...
  bold_labels() %>%
  italicize_levels()
table10H <- weighted_logit10H_2019 %>%
  tbl_regression(label = list(HHAGEx = "Age of Household Head"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
  ...
  bold_labels() %>%
  italicize_levels()
table11H <- weighted_logit11H_2019 %>%
  tbl_regression(label = list(MSTATUS = "Marital Status of Women"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table12H <- weighted_logit12H_2019 %>%
  tbl_regression(label = list(HH51_grouped = "Number of Children under age 5"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
table13H <- weighted_logit13H_2019 %>%
  tbl_regression(label = list(HH52_grouped = "Number of Children age 5-17"),
                 exponentiate = TRUE,
                 pvalue_fun = ~ style_pvalue(.x, digits = 2),
  ) %>%
...
# Stack the tables vertically
stacked_table1AH <- tbl_stack(
  tbls = list(table1H, table2H, table3H, table4H, table5H, table6H, table7H, table8H, table9H, table10H, table11H, table12H, table13H)
)
# Convert the gtsummary table to a gt table
stacked_gtAH <- as_gt(stacked_table1AH) %>%
  gt::tab_header("Staying away from religious work")
# Save the gt table as an image
gtsave(stacked_gtAH, "bivariate_staying_away_from_religious_work.png")
...
table1_2019 <- create_regression_table1_2019(chaupadi, list(HH7 = "Region", HC1A = "Religion of Household Head", Ethnicity = "Ethnicity of Household Head", windex5r = "Rural Wealth Index", HC15 = "Owns Agricultural Land", helevel1 = "Education of Household head", welevel1 = "Education of Women", HH52_grouped = "Number of Children Aged 5-17"))
table2_2019 <- create_regression_table1_2019(separate_room, list(HH7 = "Region", HC1A = "Religion of Household Head", Ethnicity = "Ethnicity of Household Head", windex5r = "Rural Wealth Index", HC15 = "Owns Agricultural Land", helevel1 = "Education of Household head", welevel1 = "Education of Women", HH52_grouped = "Number of Children Aged 5-17"))
table3_2019 <- create_regression_table1_2019(cowshed, list(HH7 = "Region", HC1A = "Religion of Household Head", Ethnicity = "Ethnicity of Household Head", windex5r = "Rural Wealth Index", HC15 = "Owns Agricultural Land", helevel1 = "Education of Household head", welevel1 = "Education of Women", HH52_grouped = "Number of Children Aged 5-17"))
table4_2019 <- create_regression_table1_2019(eating_separate, list(HH7 = "Region", HC1A = "Religion of Household Head", Ethnicity = "Ethnicity of Household Head", windex5r = "Rural Wealth Index", HC15 = "Owns Agricultural Land", helevel1 = "Education of Household head", welevel1 = "Education of Women", HH52_grouped = "Number of Children Aged 5-17"))
